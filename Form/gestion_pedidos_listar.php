	...
	<div class="card-body" id="divcabecera_1" >
		<div class="row">
			...
			<div class="card border-success">
				<div class="card-header text-white bg-success " ><b><h4 class="text-white"><img src="../icon/pedidos_gestion.png" style="width: 30px; height: 30px;"> Gestión de Pedidos <a href="#"  class='btn btn-outline-dark btn-sm' id='btnuevopedido'>Nuevo </a></h4></b>
					<div class="form-row">
						...
						<div  class="col-sm-3">
							...
							<input type="text" class="form-control" name="txtbuscar" id="txtbuscar" placeholder="Clientes" style="text-align: center;" >
						</div>
					...
					<div class="card border-success ">
					  <div class="card-header text-white bg-success  ">
					    <ul class="nav nav-tabs card-header-tabs">
					      ...
					      <!--li class="nav-item">
					        <a class="nav-link" href="#" id="pngestionar_pedidos" >Gestionar pedidos</a>
					      </li-->
					    </ul>
					  </div>
					  <div class="card-body">
...
$(document).on("click","#btprocesar_pedidos",function(){
...
function verificar_plantillas(){
	...
	$.ajax({
		url:"gestion_pedidos_listar_funciones.php",
		method: "POST",
		data: {param:10,
