...
<div class="row">
	...
	<div class="card border-primary">	
		...
		<div class="card-header text-danger" >
			...
			<div class="form-row">		
				<div  class="col-sm-2">
				<label for=""><b>RUC|DNI</b></label>				
				<input type="text" class="form-control" name="txtdnivendedor" id="txtdnivendedor" style="text-align: center;" >
				<input type="hidden" class="form-control" name="txtidbeneficiario" id="txtidbeneficiario">
				</div>

				<div  class="col-sm-5">
				<label for=""><b>Cliente</b></label>				
				<input type="text" class="form-control" name="txtcliente" id="txtcliente" style="text-align: center;" disabled >
				</div>
...
$(document).on("click","#btimprimirdespacho",function(){
	...
	var axcodmovcz = $("#txtcodmovcz").val();
  	...
  	$.ajax({
 		...
 		url:"pedidos_clientes_funciones.php",
		method: "POST",
